...
public partial class SoftUniContext : DbContext
{
    ...
    public virtual DbSet<EmployeesDemo> EmployeesDemos { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=.;Database=SoftUni;Trusted_Connection=true;TrustServerCertificate=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.EmployeeId).HasName("PK__Deleted___7AD04F11E2BE1BF5");
        ...
        {
            entity.ToTable(tb => tb.HasTrigger("InsertDeletedRecord"));
        ...
        modelBuilder.Entity<EmployeesDemo>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("EmployeesDemo");
